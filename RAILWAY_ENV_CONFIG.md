...
### CORS Configuration
```
ALLOWED_HOSTS=aurum-solar.vercel.app,aurum-solar-frontend.vercel.app,localhost
```
...
### External Services
```
NYC_API_BASE_URL=https://data.cityofnewyork.us
...
EMAIL_FROM=noreply@aurumsolar.com
```
...
Railway will automatically provision PostgreSQL and Redis services. The connection URLs will be provided in the `DATABASE_URL` and `REDIS_URL` environment variables.

## Custom Domain Configuration

1. Go to Settings > Domains
2. Add your custom domain (e.g., api.aurumsolar.com)
